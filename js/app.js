(() => {
    ...
    function initSliders() {
        if (document.querySelector(".about__slider")) new swiper_core_Swiper(".about__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".about__arrow--left.swiper-button-prev",
                nextEl: ".about__arrow--right.swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".body-recipes__slider")) new swiper_core_Swiper(".body-recipes__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".body-recipes__arrow.swiper-button-prev",
                nextEl: ".body-recipes__arrow.swiper-button-next"
            },
            on: {}
        });
    }
